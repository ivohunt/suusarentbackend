package com.suusarent.suusarentback.controller.login;
...
public class LoginController {
    ...
    @Operation(summary = "Sisse logimine. Tagastab userId ja roleName",
            description = "Süsteemist otsitakse emaili ja password abil kasutajat, kelle konto on ka aktiivne. Kui vastet ei leita vistakse viga errorCode'ga 111")
    @ApiResponses(value = {
